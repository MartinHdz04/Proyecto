...
labels = ['MangoAzucar', 'guatila', 'mangoHilacha', 'mangoKeitt',
       'mangoTommy', 'mangoYulima', 'papaCriolla', 'papaPastusa',
       'papaSabanera', 'papaya', 'sandia', 'yuca']
...
score1 = predictions[0][posicion1]  # score de la clase predicha
